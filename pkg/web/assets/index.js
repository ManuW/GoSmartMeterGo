...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initCharts();
    startLiveStream();
    initBackupTrigger(); // Backup-Trigger-Event initialisieren
...
function startLiveStream() {
    ...
    eventSource.onerror = (err) => {
        ...
        document.getElementById('sml-status').className = "badge badge-error";
        document.getElementById('sml-status').innerText = "SML: getrennt";
        document.getElementById('sma-status').className = "badge badge-error";
        document.getElementById('sma-status').innerText = "SMA: getrennt";
    };
}
...
function loadDailyUsageData() {
    ...
    if (currentDailyScope === 'year') {
        ...
        url = `/api/daily?start=${sStr}&end=${eStr}`;
...
// Initialisiert den Button für den manuellen Online-Backup-Upload
